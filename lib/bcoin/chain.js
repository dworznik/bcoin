...
Chain.prototype._saveEntry = function _saveEntry(entry, save, cb) {
  if (save)
    this.db.save(entry, cb);
...
Chain.prototype._saveEntrySync = function _saveEntrySync(entry, save) {
  if (save)
    this.db.saveSync(entry);
